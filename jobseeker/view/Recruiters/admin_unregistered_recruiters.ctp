...
<div class="prof index">
 ...
 <form action="<?php echo $this->webroot;?>admin/recruiters/unregistered_recruiters" name="adminSearchRecruiterForm" method="get" id="adminSearchRecruiterForm">
   <div class="inputs">
...
<a style="float:right; padding-top:12px;" href="<?php echo $this->webroot;?>admin/recruiters/unregistered_recruiters">View All</a>
</form> 
