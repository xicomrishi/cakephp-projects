...
<div class="bottom_line <?php echo $color;?>" id="top_bottom_line" style="display:block">
	<div class="wrapper">
        ...
        <div onclick="$('.select_box').removeClass('active'); $(this).addClass('active');" class="select_box black">
			...
			<ul class="drop_down">
				<li><label><input type="checkbox" name="track_status" value="Status change" onchange="updateTrackEvent(this);" <?php if(!empty($trackArray) && in_array('Status change',$trackArray)){ ?> checked="checked" <?php }?>>Change of Status</label></li>
				<li><label><input type="checkbox" name="track_location" value="Preferred location change" onchange="updateTrackEvent(this);" <?php if(!empty($trackArray) && in_array('Preferred location change',$trackArray)){ ?> checked="checked" <?php }?>>Change in Preferred Locations</label></li>
                 <li><label><input type="checkbox" name="track_notice" value="Notice period change" onchange="updateTrackEvent(this);" <?php if(!empty($trackArray) && in_array('Notice period change',$trackArray)){ ?> checked="checked" <?php }?>>Change in Notice Period</label></li>
                <li><label><input type="checkbox" name="track_profile" value="Any profile change" onchange="updateTrackEvent(this);" <?php if(!empty($trackArray) && in_array('Any profile change',$trackArray)){ ?> checked="checked" <?php }?>>Change in any profile information</label></li>
			</ul>
		</div>
