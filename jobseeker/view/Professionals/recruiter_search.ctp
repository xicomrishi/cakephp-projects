      	...
      	<section class="details_section">
                    ...
                    <section class="details">
                    	<section class="top_section">
                        	<label>
                             <a target="_blank" href="<?php echo $this->webroot;?>recruiters/recruiter_profile/<?php echo $recruiterList['Recruiter']['id'];?>"><?php echo trim($recruiterList['Recruiter']['first_name'].' '.$recruiterList['Recruiter']['last_name']);?></a></label>
                            <?php 
							   $online_profiles=unserialize(base64_decode($recruiterList['Recruiter']['online_profiles']));
