	...
	<div align="center" class="greybox mtop15">
			...
			<table class="allUsers" cellspacing="0" cellpadding="7" border="0" align="center">
				<tr>
					...
					<td>
						<?php 						
							echo $this->Form->input('checkall', array('type'=>'checkbox',  'label' => 'Check All','id'=>'checkall','onclick' => 'update_is_checked();',  'name'=>'checkall'));
						?> 
						<div class="loadUser sharedUser">						
							<?php //foreach($emails as $key=>$email) { ?>
							<div class="multipleUsers">
								<?php echo $this->Form->input('users', array(
																	'type'=>'select', 'class' => 'multipleUser musers',
			...
			<?php echo $this->Form->create('AdminClientMarketingEmail', array('url' => array('controller'=>'emails','action'=>'marketing_schedule_edit_email'), 'type'=>'file', 'class' => 'aa', 'id' => 'marketing_email', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => false))) ?>
			<?php 						
			...
			<table cellspacing="0" cellpadding="7" border="0" align="center">
				...
				<tr>
					...
					<td><?php echo $this->Form->input('file', array('type'=>'file', 'class' => 'input', 'style' => "width: 450px;",'label'=>false,'div'=>false,'required'=>false)); ?></td>
