...
<div class="users index">
	<h2>
		<?php echo __('Marketing Draft Email'); ?>
	</h2>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<tr class="<?php $bgClass?>">	
				...
				<td align="center" valign="middle" >					
					<?php echo $this->Html->link($this->Html->image('/admin/images/edit_icon.gif'), array('controller' => 'emails', 'action' => 'marketing_draft_edit_email', $row['id']), array('escape' => false, 'title' => 'Edit Email')); ?>
				</td>		
			</tr> 
		<?php
				$i++; 
