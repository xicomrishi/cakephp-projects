...
<div class="users index">
	<h2>
		<?php echo __('Marketing Email History'); ?>
	</h2>
	...
	echo $this->Form->create('User', array( 'url' => array('controller'=>'emails','action'=>'manage','admin' => true)) ); ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<tr>	
				...
				<th width="15%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('created', 'Send Date'); ?></th>
			...
			<tr class="<?php $bgClass?>">	
				...
				<td align="center" valign="middle" >
					<?php echo $this->Html->link($this->Html->image('/admin/images/view.gif'), array('controller' => 'emails', 'action' => 'marketing_history_email_view_users', $row['id']), array('escape' => false, 'title' => 'View User List')); ?>
					<?php echo $this->Html->link($this->Html->image('/admin/images/resend.png'), array('controller' => 'emails', 'action' => 'marketing_resend_email', $row['id']), array('escape' => false, 'title'=>'Resend Emails')); ?>
				</td>		
			</tr> 
		<?php
				$i++; 
