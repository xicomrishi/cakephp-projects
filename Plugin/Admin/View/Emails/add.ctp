<script type="text/javascript">
  ...
  <?php
	echo $this->Html->script(array('fckeditor'), array('inline' => false));
  ?>
	...
	<div align="center" class="greybox mtop15">
		<?php echo $this->Form->create('EmailTemplate', array('url' => array('controller'=>'emails','action'=>'add'), 'name' => 'frm_addedit', 'id' => 'frm_addedit', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => false, 'type'=>'text'))) ?>
			<?php echo $this->Form->input('id', array('type'=>'hidden')); ?>
			
			<table cellspacing="0" cellpadding="7" border="0" align="center">
				<tr>
					<td valign="middle"><strong class="upper">Template Name:</strong></td>
					<td><?php echo $this->Form->input('email_identifier',array('class' => 'input required', 'empty'=>'- Select Email For -', 'label' => false, 'error' => false, 'div' => false, 'style'=>'width: 450px;'));
 ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<?php echo $this->Form->input('content',array('class' => 'input ckeditor', 'label' => false,'rows' => '10', 'error' => false, 'div' => false, 'style'=>'width: 450px;')); ?>
					</td>
					<td>
