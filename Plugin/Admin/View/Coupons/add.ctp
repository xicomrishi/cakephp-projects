...
<script type="text/javascript">
	...
	<div align="center" class="greybox mtop15">
		<?php echo $this->Form->create('Coupon', array('url' => array('controller'=>'coupons','action'=>'add'), 'type' => 'file','name' => 'frm_addedit', 'id' => 'frm_addedit', 'inputDefaults' => array('label' => false, 'div' => false, 'error' => false, 'type'=>'text'))) ?>
 ...
 ?></td>
				...
				<tr>
					...
					<td><?php echo $this->Form->input('image', array('class' => 'input required', 'type' => 'file', 'label'=>false,'div'=>false,'required'=>'required')); ?></td>
				</tr>
				<tr>
					<td valign="middle"><strong class="upper">Description:</strong></td>
					<td><?php 
					
					echo $this->Form->input('description', array('class' => 'input ckeditor', 'label'=>false, 'rows' => 10,'div'=>false,'required'=>'required')); ?></td>
				</tr>
