	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
		<tr valign="top">
		  <td align="left" class="searchbox">
			...
			<?php echo $this->Html->link('<span>Assign Users</span>', array('controller' => 'users', 'action' => 'subadmin_assign_users',$subadmin_id , 'plugin' => 'admin'), array('class' => 'black_btn', 'escape' => false)); ?>
	  ...
	  ?>
		 <tr>
			...
			<!--<td align="center" valign="middle" >&nbsp;
				<?php //echo $this->Html->link($this->Html->image('/admin/images/close.png'), array('controller' => 'users', 'action' => 'subadmin_remove_assign_user', $user['Admin']['id']), array('escape' => false)); ?>
