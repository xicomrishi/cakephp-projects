...
<div class="row mtop15">
	<?php if($this->Session->read('Auth.User.type') != '3'){ ?>
		...
		<tr valign="top">
		  ...
		  <td align="left" class="searchbox">	
			...
			<div class="floatright top5">
				<?php echo $this->Html->link('<span>Manage Deals</span>', array('controller' => 'users', 'action' => 'deal_report_client', 'plugin' => 'admin'), array('class' => 'black_btn', 'escape' => false)); ?>
			</div>
			  ...
			  <?php if(!empty($records)) { $i=1; ?>
				  <?php	 foreach($records as $record) { ?>
					 <tr>
						...
						<td align="left">
							<span class="blue">
								<?php echo ucfirst($record['AdminClientDealShare']['created']); ?>
							</span>
						</td>
						<td align="left">
							<span class="blue">
