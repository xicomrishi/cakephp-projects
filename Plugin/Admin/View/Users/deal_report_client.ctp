	...
	<?php echo $this->Form->create(array('url' => '/admin/users/deals', 'type' => 'post'));  ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			  <tr>
				...
				<th width="38%" align="left"><?php echo $this->Paginator->sort('total_friend_view', 'Total Views', array('title' => 'This feild shows the total friends and followers for the users who have shared this deal')); ?></th>
