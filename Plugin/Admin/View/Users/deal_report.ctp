	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
		<tr valign="top">
		  <td align="left" class="searchbox">	
			<div class="floatleft">
				<?php echo $this->Form->create(array('url' => '/admin/users/deal_report', 'type' => 'get'));  ?>
	...
	<?php echo $this->Form->create(array('url' => '/admin/users/deals', 'type' => 'post'));  ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			  <tr>
				...
				<th width="38%" align="left"><?php echo $this->Paginator->sort('Company Name'); ?></th>
				<th width="38%" align="left"><?php echo $this->Paginator->sort('Total Friend View'); ?></th>
				<th width="38%" align="left"><?php echo $this->Paginator->sort('Total Share'); ?></th>
		  ...
		  <?php if(!empty($records)) { $i=1; ?>
			  <?php	 foreach($records as $record) { ?>
				 <tr>
					...
					<td align="left">
						<?php echo $this->Html->link($this->Html->image('/admin/images/view.gif'), array('controller' => 'users', 'action' => 'deal_report_view', $record['AdminClientDeal']['id']), array('escape' => false)); ?>
					</td>
				  </tr>
			 <?php } ?>
			<tr align="right">
