	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
		<tr valign="top">
		  <td align="left" class="searchbox">
			...
			<?php echo $this->Html->link('<span>Add Sub-admin</span>', array('controller' => 'users', 'action' => 'subadmin_add', 'plugin' => 'admin'), array('class' => 'black_btn', 'escape' => false)); ?>
	  ...
	  ?>
		 <tr>
			...
			<td align="center" valign="middle" >&nbsp;
				<?php echo $this->Html->link($this->Html->image('/admin/images/view.gif'), array('controller' => 'users', 'action' => 'subadmin_view_assign_users', $user['Admin']['id']), array('escape' => false)); ?>
				<?php echo $this->Html->link($this->Html->image('/admin/images/edit_icon.gif'), array('controller' => 'users', 'action' => 'subadmin_edit', $user['Admin']['id']), array('escape' => false)); ?>
			</td>
