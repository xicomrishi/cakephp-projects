	...
	?>
	    <table cellspacing="0" cellpadding="7" border="0" align="center">
			...
			<tr>
				...
				<td align="left">	
					<?php echo $this->data['Admin']['email']; ?>
				</td>
			</tr>		
			<tr>
				<td align="left">					
			...
			<tr>
				...
				<td align="left">
					...
					<div>
						<a href="http://socialeyes.ws/fsoc/index.php?route=users/login" target="_blank">http://socialeyes.ws/fsoc/index.php?route=users/login</a>
					</div>
				</td>
				<td align="left">	
					<?php 
							echo $this->html->image('help.png', array(													
													'class' => 'help toolTip', 
													'title'=>'We recommend using your business\'s social media feed on your SOCIAL REFERRALS™ Landing Page. You can go to http://feedgrabbr.com and create your custom feed there. Then simply paste the code from feedgrabbr here. If you do not choose this option a map of your location will be placed there instead. See a sample Socail Referrals page here.'
												)
											);
					?>
				</td>
			...
			<tr>
				...
				<td align="left">	
					<?php 
							echo $this->html->image('help.png', array(													
													'class' => 'help toolTip', 
													'title'=>'If you do not know your Facebook Page ID please go to http://findmyfacebookid.com'
												)
											);
					?>
				</td>				
			...
			<tr>
				...
				<td align="left">	
					<div id="texture_preview"  style="display:none; cursor:pointer; border: 1px solid #000; width:70px; height:70px; margin-left:26px;">
						<img src="<?php echo $this->webroot; ?>img/textures/texture_<?php if(!empty($this->request->data['Admin']['bg_texture'])) echo $this->request->data['Admin']['bg_texture']; else echo '1'; ?>.png" height="70" width="70" />
					</div>
...
function readURL(input) {
	if (input.files[0] && input.files[0]) {
		...
		reader.onload = function (e) {
			$('#logo_prev').attr('src', e.target.result).css('max-width:80px');
		};
