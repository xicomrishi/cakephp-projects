   ...
   <?php 
	...
	?>
	    <table cellspacing="0" cellpadding="7" border="0" align="center">
					...
					<span>
						<?php 
								echo $this->Form->input('website_url', array(
														...
														'id' => 'website_url',
														'style'=>'width: 450px;',
														'onBlur' => 'generate_website_url(this.value);'
													)
												);
						?>
					</span>
			...
			<tr>
				...
				<td align="left">	
					...
					<?php 
									...
									echo $this->Form->input('display_form_type', array(
																			'type' => 'radio',
																			'div' => false,
																			'legend' => false,
			...
			<tr id="website_image_block" style="display: none;">
				<td align="left">					
			...
			<tr class="website_image_block"  style="display: none;">
				<td align="left">					
			...
			<tr>
				<td align="left">					
					<strong class="upper">Website Color</strong>
				</td>
				<td align="left">	
					<?php 
...
function view_texture()
{
	...
	$(document).ready(function (){
		...
		<?php if(!isset($this->request->data['Admin']['display_form_type'])){	?>
				//$('#AdminDisplayFormType1').prop('checked', true);
		<?php } ?>	
