...
<div align="center" class="whitebox mtop15">
	    ...
	    <table cellspacing="0" cellpadding="7" border="0" align="center">
			...
			<tr>
				<td align="left">					
					<strong class="upper">Landing Page URL</strong>
					
				</td>
				<td align="left">	
					<span>
						<?php echo $this->Html->link(SITE_URL.'w/'.$user_info['Admin']['website_url'], 
											SITE_URL.'w/'.$user_info['Admin']['website_url'],
			...
			<tr>
				...
				<td align="left">	
					<span>
						<?php echo $this->Html->link(SITE_URL.trim(str_replace(' ','-',$user_info['Admin']['tablet_url'])), 
											SITE_URL.trim(str_replace(' ','-',$user_info['Admin']['tablet_url'])), 
