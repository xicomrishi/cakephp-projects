...
require_once 'service'.DIRECTORY_SEPARATOR.'Google_Model.php';
require_once 'service'.DIRECTORY_SEPARATOR.'Google_Service.php';
require_once 'service'.DIRECTORY_SEPARATOR.'Google_ServiceResource.php';
require_once 'auth'.DIRECTORY_SEPARATOR.'Google_AssertionCredentials.php';
require_once 'auth'.DIRECTORY_SEPARATOR.'Google_Signer.php';
require_once 'auth'.DIRECTORY_SEPARATOR.'Google_P12Signer.php';
require_once 'service'.DIRECTORY_SEPARATOR.'Google_BatchRequest.php';
require_once 'external'.DIRECTORY_SEPARATOR.'URITemplateParser.php';
require_once 'auth'.DIRECTORY_SEPARATOR.'Google_Auth.php';
require_once 'cache'.DIRECTORY_SEPARATOR.'Google_Cache.php';
require_once 'io'.DIRECTORY_SEPARATOR.'Google_IO.php';
require_once('service'.DIRECTORY_SEPARATOR.'Google_MediaFileUpload.php');
