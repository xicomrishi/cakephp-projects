 ...
 * @author Chris Chabot
 */
class osapiApcStorage extends osapiStorage {

  public function __construct() {
    if (! function_exists('apc_add')) {
      throw new osapiStorageException("Apc functions not available");
    }
  }
  ...
  public function set($key, $value) {
    if (@apc_store($key, array('time' => time(), 'data' => serialize($value))) == false) {
      throw new osapiStorageException("Couldn't store data");
    }
  }
