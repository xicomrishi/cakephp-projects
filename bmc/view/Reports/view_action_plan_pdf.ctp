          ...
          if($ques['APquestion']['question_key']==4){ 
             $html.= '<tr><td><table width="100%" class="formTable"><tr><td valign="top" width="64.8%" class="full">&nbsp;</td><td valign="top" width="20%">'.__('By When').'?</td><td valign="top" width="20%">'.__('By Whom').'?</td></tr></table></td></tr>';
				...
				if($m==1) $number='a)'; else if($m==2) $number='b)'; else if($m==3)  $number='c)';
					if($ques['APquestion']['question_key']==4){ 
					  $html.= '<tr><td><table width="100%" style="padding:2px;"><tr><td valign="top" width="64.8%" class="full top">'.$number.'. '.$response[$i][$j]['response'][$m][1].'</td><td valign="top"  class="top"width="20%">'.$response[$i][$j]['response'][$m]['when'].'</td><td valign="top" class="top" width="20%">'.$response[$i][$j]['response'][$m]['whom'].'</td></tr></table></td></tr>';
                              }else{                                        
                     $html.= '<tr><td valign="top" class="top">'.$number.'. '.$response[$i][$j]['response'][$m].'</td></tr>';
                        }
					} 
    $html.= '</table>
                     </td>
