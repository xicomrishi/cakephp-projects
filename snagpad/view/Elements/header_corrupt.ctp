...
<section class="top_section">
      ...
      <section class="header_details"><a href="<?php echo SITE_URL;?>/jobcards/index"><?php echo $this->Html->image('inner_logo.png', array('alt' => '', 'border' => '0','escape' => false,'class'=>'inner_logo')); ?></a>
        ...
        <section class="searchometer">
          <h3>SEARCHOMETER</h3>
          <ul>
            <li class="first" onmouseout="hideTooltip();" onmouseover="showTooltip(event,'The strategic score is based on the aggregate of all checked items in the strategies tab across all of your job cards. The more items you check, the higher your score.');">
            ...
            <li class="third" onmouseout="hideTooltip();" onmouseover="showTooltip(event,'The intensity score is the percentage of challenges completed for the present week. The more challenges you complete, the higher your score. Challenges are coming soon!');">
            ...
            <li><strong><?php echo $this->Html->link('CONTACTS','/contacts/index');?></strong>
              <ul class="space">
                ...
                <li><?php echo $this->Html->link($this->Html->image('small_icon3.png', array('alt' => '', 'border' => '0')),array('controller'=>'contacts','action'=>'export'), array('escape' => false)); ?></li>
                 <li><a id="count_network" href="<?php echo SITE_URL; ?>/contacts/show_contact_network/<?php echo $this->Session->read('Account.id');?>" style=" display:inline-block;min-height:16px; padding:3px 0 0 0; min-width:19px; text-align:center; color:#fff; text-decoration:none;"><?php echo $contact_count; ?></a></li>
              </ul>
            </li>
          </ul>
        </section>
...
{
	$.post('<?php echo SITE_URL;?>/challenges/checkChallenge','clientid='+clientid,function(data){});
}
