<table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:12px; line-height:14px; color:#404040">       
        ...
        <tr>
        <td style="padding:6px 0 6px 15px; width:555px">Thank you again for supporting my job search. Please let me know if I or my network can help you in any way.</td>
        </tr>
        <td style="padding:6px 0 6px 15px; width:555px">
        <table style="width:555px">
        <tr><td>Sincerely,<br><?php echo $data['from_user']['Account']['name']; ?></td><td style="folat:right;width:300px"><a href="<?php echo SITE_URL; ?>/info/shoping_cart/1-day-trail-free" alt="Want your own Snagpad Account(Free)" ><?php echo $this->Html->image(SITE_URL.'/img/want-account.png',array('escape'=>false,'alt'=>"Want your own Snagpad Account(Free)"));?></a></td></tr>
        </table>
        </tr>
        </table>