...
<table border="0" cellpadding="0" cellspacing="0" width="100%">        
        ...
        <tr>	<!--single text line 6-->
        	<td width="100%" align="left" valign="middle" style="font-size:14px; line-height:16px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; color:#404040;">The following clients have not moved a job card in a while now.For more details about the job card, click on the client you want to view and go through the job cards that have not moved. <?php echo $data['CH']['Coach']['card_moved'].' days :'; ?><br/><br/><?php foreach($data['CL'] as $cl){ 
				...
				$query_string1 = "file=jobcards&action=index&client_id=".$cl['C']['id'];
							$url1 =$site_url. "/Pages/display?".$query_string1;	
							echo $this->Html->link($cl['card_move']['name'],$url1,array('escape' => false)); 
							echo ' - '.$cl['card_move']['email'];
							?><br/>
					<?php 	}} ?></td>
        </tr>
         <tr><td height="15" width="100%" style="font-size:0px"></td></tr>
        	...
        	<td width="100%" align="left" valign="middle" style="font-size:14px; line-height:16px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; color:#404040">The following clients have updated their job preferences:<br/><br/><?php foreach($data['CL'] as $cl){ 
				if(isset($cl['job_pref_update'])){ 
							...
							$url1 =$site_url. "/Pages/display?".$query_string1;	
								...
								echo '<b>Job A: </b>'.$cl['job_pref_update']['job_A'].'<br><b>Job B Criteria: </b>'.$cl['job_pref_update']['job_Criteria'];
								echo '<br>';
								?>
...
<td width="180" valign="top">
    ...
    <td>
        <table  border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td style="font-size:14px; line-height:16px; color:#0a79a7; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"><?php echo $this->Html->image($site_url.'/img/green.png',array('escape'=>false,'border'=>'0'));?>&nbsp;Active Clients - <b><?php echo $check['active']; ?></b></td>
            </tr>
            <tr><td style="font-size:0px;" height="8"></td></tr>
            <tr>
                <td style="font-size:14px; line-height:16px; color:#0a79a7; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"><?php echo $this->Html->image($site_url.'/img/yellow.png',array('escape'=>false,'border'=>'0'));?>&nbsp;Active 3 Days - <b><?php echo $check['active_three']; ?></b></td>
            </tr>
            <tr><td style="font-size:0px;" height="8"></td></tr>
            <tr>
                <td style="font-size:14px; line-height:16px; color:#0a79a7; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"><?php echo $this->Html->image($site_url.'/img/red.png',array('escape'=>false,'border'=>'0'));?>&nbsp;Active >5 Days - <b><?php echo $check['active_five'];?></b></td>
            </tr>
            <tr><td style="font-size:0px;" height="8"></td></tr>
            <tr>
            ...
            <tr><td style="font-size:0px;" height="8"></td></tr>
            <tr>
                <td style="font-size:14px; line-height:16px; color:#0a79a7; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;">Avg S-A-I -<b><?php echo round($check['avg_S_cards'],2).'-'.round($check['avg_A_cards'],2).'-'.round($check['avg_I_cards'],2);?></b></td>
            </tr>
        </table>
    </td>
    </tr>
