...
<form id="mailprefForm" name="mailprefForm" action="" method="post">
        ...
        <input type="radio" name="data[Client][reminder_mail]" value="1" <?php if($client['Client']['reminder_mail']=='1'){echo 'checked';}?>/><span class="text">Yes</span>
         <input type="radio" name="data[Client][reminder_mail]" value="0" <?php if($client['Client']['reminder_mail']=='0'){echo 'checked';}?>/><span class="text">No</span>
        </section>
