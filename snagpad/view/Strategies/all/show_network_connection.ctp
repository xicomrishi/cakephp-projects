...
<div class="strategy_pop_up" style="width:203px !important;   overflow:hidden">
 ...
 <div id="info_contact" style="width:580px">
        ...
        <span class="column1 colour2" style="width:179px; min-height:110px"><?php if(isset($fb_friends[$i]['name'])){echo "<a href='http://facebook.com/profile.php?id=".$fb_friends[$i]['uid']."' target='_blank'>"; echo "<img src='https://graph.facebook.com/".$fb_friends[$i]['uid']."/picture' alt='".$fb_friends[$i]['name']."' title='".$fb_friends[$i]['name']."' border='0' align='absmiddle'><br>";   echo $fb_friends[$i]['name']."</a>";?><input type="checkbox" name="include[]" id="include[]" class="connection" value="<?php echo $fb_friends[$i]['uid']; ?>" title="<?php echo $fb_friends[$i]['name'];?>"/><?php } ?></span>
        <span class="column2 colour2" style="width:179px; min-height:110px"><?php if(isset($fb_friends[$j]['name'])){echo "<a href='http://facebook.com/profile.php?id=".$fb_friends[$j]['uid']."' target='_blank'>"; echo "<img src='https://graph.facebook.com/".$fb_friends[$j]['uid']."/picture' alt='".$fb_friends[$j]['name']."' title='".$fb_friends[$j]['name']."' border='0' align='absmiddle'><br>";   echo $fb_friends[$j]['name']."</a>"; ?><input type="checkbox" name="include[]" id="include[]" class="connection" value="<?php echo $fb_friends[$i]['uid']; ?>" title="<?php echo $fb_friends[$i]['name'];?>"/><?php } ?></span>
        <span class="column3 colour2" style="width:179px; min-height:110px"><?php if(isset($fb_friends[$k]['name'])){echo "<a href='http://facebook.com/profile.php?id=".$fb_friends[$k]['uid']."' target='_blank'>"; echo "<img src='https://graph.facebook.com/".$fb_friends[$k]['uid']."/picture' alt='".$fb_friends[$k]['name']."' title='".$fb_friends[$k]['name']."' border='0' align='absmiddle'><br>";   echo $fb_friends[$k]['name']."</a>"; ?><input type="checkbox" name="include[]" id="include[]" class="connection" value="<?php echo $fb_friends[$i]['uid']; ?>" title="<?php echo $fb_friends[$i]['name'];?>"/><?php } ?></span>
