...
<section class="heading_row">
        <span class="col1">JOB TITLE</span>
        <span class="col2 "><strong>COMPANY NAME</strong></span>
        <span class="col3 "><strong>COUNTRY</strong></span>
        ...
        <section class="heading_row">
        <span class="col1"><?php echo $result['C']['position_available'];?></span>
        <span class="col2"><?php echo $result['C']['company_name'];?></span>
        <span class="col3 spacer"><?php echo $result['C']['country'];?></span>
