...
<input type="hidden" name="release" value="" id="release" />
 <section class="heading_row">
        <span class="coln1" style="width:80px"><input type="checkbox" class="checkall" /></span>
        ...
        <span class="coln6"><b><?php echo $this->Paginator->sort('Client.count_colS','S');?></b>-<b><?php echo $this->Paginator->sort('Client.count_colA','A');?></b>-<?php echo $this->Paginator->sort('Client.count_colSI','SI');?>-<b><?php echo $this->Paginator->sort('Client.count_colI','I');?></b>-<?php echo $this->Paginator->sort('Client.count_colV','V');?>-<?php echo $this->Paginator->sort('Client.count_colJ','J');?></span>
        <span class="coln7">Action</span>
        </section>
        
        <?php foreach($clients as $client){?>
        <section class="cmn_row">
        <span class="coln1" style="width:80px"><input type="checkbox" class="client_check" name="cbox[]" onclick="check(this)" value="<?php echo $client['Client']['account_id']; ?>"></span>
        ...
        <span class="coln3 color" id="client_<?php echo $client['Client']['account_id'];?>" style="width:160px"><?php if($client['C']['name']!='') echo $client['C']['name']; else echo 'NA'?></span>
