...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        echo $this->Html->script(array('jquery', 'cufon-yui', 'cufon', 'Conduit_ITC_400.font', 'Conduit_ITC_700.font', 'Conduit_ITC_italic_400.font', 'Conduit_ITC_italic_700.font','jquery.validate.min','popup','jquery.tinyscrollbar'));?>
