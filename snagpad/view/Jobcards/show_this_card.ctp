<section class="main_section">
 ...
 <?php if($card['Card']['column_status']=='O') { ?> 
  ...
  <div class="card" onclick="show_job_details('<?php echo $card['Card']['id']; ?>','<?php echo $card['Card']['id'];?>');">
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 17); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>


  </div>
  <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','O');" class="display_content">Apply</span></div>
  
  <ul class="icon"> 
  <li><a href="javascript://" onclick="show_card_cont('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon1.jpg',array('escape'=>false));?></a></li>
   <li><a href="javascript://" onclick="move_to_recycle('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon2.jpg',array('escape'=>false));?></a></li>
    <li class="last"><a href="javascript://" onclick="show_card_net('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon3.jpg',array('escape'=>false));?></a></li>
  </ul>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 17); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
       ...
       <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','A');" class="display_content">Set Interview</span></div>
        <ul class="icon"> 
   <li><a href="javascript://" onclick="show_card_cont('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon1.jpg',array('escape'=>false));?></a></li>
   <li><a href="javascript://" onclick="move_to_recycle('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon2.jpg',array('escape'=>false));?></a></li>
    <li class="last"><a href="javascript://" onclick="show_card_net('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon3.jpg',array('escape'=>false));?></a></li>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 17); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
       ...
       <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','S');" class="display_content">Interview</span></div>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 17); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
      ...
      <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','I');" class="display_content">Verbal Job Offer</span></div>
       <ul class="icon"> 
  <li><a href="javascript://" onclick="show_card_cont('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon1.jpg',array('escape'=>false));?></a></li>
   <li><a href="javascript://" onclick="move_to_recycle('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon2.jpg',array('escape'=>false));?></a></li>
    <li class="last"><a href="javascript://" onclick="show_card_net('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon3.jpg',array('escape'=>false));?></a></li>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 17); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
       ...
       <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','V');" class="display_content">Job</span></div>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 17); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
       ...
       <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','J');" class="display_content" style="padding:13px 16px 0 0;">Complete</span></div>
        <ul class="icon"> 
  <li><a href="javascript://" onclick="show_card_cont('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon1.jpg',array('escape'=>false));?></a></li>
   <li><a href="javascript://" onclick="move_to_recycle('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon2.jpg',array('escape'=>false));?></a></li>
    <li class="last"><a href="javascript://" onclick="show_card_net('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>');"><?php echo $this->Html->image('social_samll_icon3.jpg',array('escape'=>false));?></a></li>
 ...
 <div class="text_box">
  ...
  ?>
  <li class="<?php if($card['Card']['column_status']=='O') echo 'active';?>" id="sub_tab_<?php echo $card['Card']['id'];?>"><a href="javascript://" class="bg_2" <?php if($p>=1){ ?>onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','O');"<?php }else{ echo 'style="font-weight:normal"';} ?>>OPPORTUNITY</a></li>
  <li class="<?php if($card['Card']['column_status']=='A') echo 'active';?>" id="sub_tab_<?php echo $card['Card']['id'];?>"><a href="javascript://" class="bg_2" <?php if($p>=2){ ?>onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','A');"<?php }else{ echo 'style="font-weight:normal"';}  ?>>APPLIED</a></li>
  <li class="<?php if($card['Card']['column_status']=='S') echo 'active';?>" id="sub_tab_<?php echo $card['Card']['id'];?>"><a href="javascript://" class="bg_2" <?php if($p>=3){ ?>onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','S');"<?php }else{ echo 'style="font-weight:normal"';}  ?>>SET INTERVIEW</a></li>
  <li class="<?php if($card['Card']['column_status']=='I') echo 'active';?>" id="sub_tab_<?php echo $card['Card']['id'];?>"><a href="javascript://" class="bg_2" <?php if($p>=4){ ?>onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','I');"<?php }else{ echo 'style="font-weight:normal"';}  ?>>INTERVIEW</a></li>
  <li class="<?php if($card['Card']['column_status']=='V') echo 'active';?>" id="sub_tab_<?php echo $card['Card']['id'];?>"><a href="javascript://" class="bg_2" <?php if($p>=5){ ?>onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','V');"<?php }else{ echo 'style="font-weight:normal"';}  ?>>VERBAL JOB OFFER</a></li>
  <li class="<?php if($card['Card']['column_status']=='J') echo 'active';?>" id="sub_tab_<?php echo $card['Card']['id'];?>"><a href="javascript://" class="bg_2" <?php if($p>=6){ ?>onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $card['Card']['id'];?>','J');"<?php }else{ echo 'style="font-weight:normal"';}  ?>>JOB</a></li>
