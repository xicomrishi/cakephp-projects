...
<?php $i=1;
 ...
 <?php if($card['Card']['column_status']=='O') { ?> 
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 18); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
       ...
       <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $i;?>','S');">Interview</span></div>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 18); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
      ...
      <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $i;?>','I');">Verbal Job Offer</span></div>
       <ul class="icon"> 
  <li><?php echo $this->Html->link($this->Html->image('social_samll_icon1.jpg', array('alt' => '', 'border' => '0')), '#', array('escape' => false)); ?></li>
   <li><?php echo $this->Html->link($this->Html->image('social_samll_icon2.jpg', array('alt' => '', 'border' => '0')), '#', array('escape' => false)); ?></li>
    <li class="last"><?php echo $this->Html->link($this->Html->image('social_samll_icon3.jpg', array('alt' => '', 'border' => '0')), '#', array('escape' => false)); ?></li>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 18); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
       ...
       <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $i;?>','V');">Job</span></div>
  ...
  <h3><?php  $c_pos_len=strlen($card['Card']['position_available']); if($c_pos_len>18){ $c_pos=substr($card['Card']['position_available'], 0, 18); echo $c_pos."...";}else{ echo $card['Card']['position_available'];} ?></h3>
       ...
       <div class="text"><?php echo $this->Html->image('bg_1.png',array('escape'=>false,'alt'=>''));?></a><span onclick="show_strategy('<?php echo $card['Card']['id'];?>','<?php echo $i;?>','J');">Complete</span></div>
        <ul class="icon"> 
  <li><?php echo $this->Html->link($this->Html->image('social_samll_icon1.jpg', array('alt' => '', 'border' => '0')), '#', array('escape' => false)); ?></li>
   <li><?php echo $this->Html->link($this->Html->image('social_samll_icon2.jpg', array('alt' => '', 'border' => '0')), '#', array('escape' => false)); ?></li>
    <li class="last"><?php echo $this->Html->link($this->Html->image('social_samll_icon3.jpg', array('alt' => '', 'border' => '0')), '#', array('escape' => false)); ?></li>
