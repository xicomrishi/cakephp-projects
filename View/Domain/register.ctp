<?php 
		echo $this->Html->css(array(
									...
									'http://dev.jtsage.com/jQM-DateBox2/css/demos.css',
...
<div class="createAccount">
  <div class="accountWrapper">
    <?php echo $this->Form->create('User', array(
												'url'=>array('controller'=>'domain', 'action'=>'register'),
												'id'=>'register',
												'inputDefaults'=>array(
      ...
      <div class="bottomSec">
        ...
        <?php echo $this->Html->link('Sign-in', array('controller'=>'domain', 'action'=>'check_auth'),array('class'=>'signIn')); ?><br/>
