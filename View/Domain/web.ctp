		...
		<div class="col-md-3 col-xs-12 col-lg-3">
			<div class="shadow" style="margin-top:20px; margin-bottom:20px;">
				...
				<div style="background-color:<?php echo !empty($user_data['Admin']['color'])?'#'.$user_data['Admin']['color']: '#5aa3c8';?>; padding:10px  5px 10px 5%;text-align:left; color:#FFF; border-radius:5px;font-size:16px;line-height:20px" align="center">
					...
					<b> <?php echo isset($user_data['Admin']['company']) ? $user_data['Admin']['company'] : ''; ?> </b>
				</div>
			</div>
					...
					<?php if ($user_data['Admin']['google_url'] != '') { ?>
						<td align="left"  >
							...
							<div class="user">
								...
								<div class="g-follow" data-annotation="bubble" data-height="24" data-href="//plus.google.com/109096629095633710546" data-rel="publisher"></div>
						...
						<?php if ($this->Session->read('Auth.User.id') == '') { ?>
							<table width="100%" border="0" cellpadding="auto" class="imgSec">
								<tr>
									...
									<td>
										<a href="<?php echo SITE_URL; ?>domain/login/facebook">
									...
									<td>
										 <a href="<?php echo SITE_URL; ?>domain/login/twitter">
									...
									<td> 
										<a href="<?php echo SITE_URL; ?>domain/login/google">
								...
								<tr>
									<td>
									   <a href="<?php echo SITE_URL; ?>domain/LinkedinLogin">
									...
									<td>
										 <a href="<?php echo SITE_URL; ?>domain/login/yahoo">
				...
				<div class="blue" style="background:<?php echo !empty($user_data['Admin']['color'])?'#'.$user_data['Admin']['color']: '#243A62';?>;">
					<?php if ($this->Session->read('Auth.User.id') == '') { ?>
						...
						echo $this->Form->create('User', array(
							'url' => array(
								'controller' => 'domain', 'action' => 'login'
							),
							'inputDefaults' => array(
