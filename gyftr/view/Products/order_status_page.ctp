<div id="form_section">
            ...
            <span class="select_dele">/ / Voucher <strong>Details</strong><a class="close" href="<?php echo SITE_URL; ?>"><?php echo $this->Html->image('close.png',array('escape'=>false,'div'=>false,'alt'=>'close'));?></a>
            </span>
...
<div class="term_cond">Click to view <a href="javascript://" onclick="show_this_tnc('<?php echo $data->ProductName; ?>','<?php echo $data->VoucherType; ?>','<?php echo $data->Value; ?>','2');">Terms &amp; Conditions</a></div>
            ...
            <div class="bottom">
                ...
                <div class="records" style=" position:absolute; text-align:center; width:100%; bottom:30px">Want to talk to us? call us at 85-1000-4444</div>
