<section class="body_container">
       		...
       		<section class="top_menu">
                <div class="wrapper">
                    <ul>
                        ...
                        <li><a href="<?php echo $this->webroot; ?>book-my-show-TnC" target="_blank">TnC</a></li>
                    </ul>
                </div>
            </section>
        	<ul class="slider">
            	<li>
                	<img src="<?php echo $this->webroot; ?>img/slide3.jpg">
                    <section class="slide_detail">
                        <div class="wrapper">
                            <section class="info">
                                <strong><img src="<?php echo $this->webroot; ?>img/book_my_show.png"></strong>
                               ...
                               <div class="list">
                                ...
                                <a href="javascript://" onclick="scrollToAnchor('.bottom_box');">REDEEM WinPin Code</a>
                            </section>
                        </div>
                     </section>
        	...
        	<div class="wrapper">            	
                ...
                <section class="right_container">
                    ...
                    <section class="information_box">
                    	<h4>BOOK MY SHOW INFORMATION</h4>
                        <ul>
                        	<li><span>HELPLINE</span><span>68886888</span></li>
                        	<li class="last"><span>WEBSITE</span><a href="#">www.bookmyshow.com</a></li>
                        </ul>
                    </section>
                </section>
            </div>
        ...
        <section class="voucher_box">
        	<div class="wrapper">
            	<h3>Book My Show Vouchers also available  at </h3>
                <ul>
        ...
        <section class="bottom_box">
        	<div class="wrapper">
        		<h3>How to Redeem at <strong style="color:#F37612">www.bookmyshow.com</strong></h3>
                <img src="<?php echo $this->webroot; ?>img/bottom_img2.png">
                <section class="buttons">
                	<a href="https://www.bookmyshow.com" target="_blank">Redeem eVoucher</a>                	
                </section>
            </div>
        </section>
    </section>
