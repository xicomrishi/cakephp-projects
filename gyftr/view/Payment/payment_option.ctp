...
<div class="con_row"><a class="done" style="font-size:18px !important; line-height:26px !important; width:28% !important" href="javascript://" onclick="redeem_points('<?php echo $user['User']['points']; ?>','<?php echo $order['Order']['total_amount']; ?>','<?php echo $user['User']['id']; ?>','<?php echo $order['Order']['id']; ?>');">Redeem Now</a></div>
</div>
