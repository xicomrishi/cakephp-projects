<style><?php ?>
#form_section form .comn_box .detail_row p { font-size:12px !important; }
</style>
<div id="form_section" style="margin:0 0 5px 0; padding:0 1%;"> <span class="select_dele">/ / Terms &amp; <strong>Conditions</strong></span>
  <form id="editGPStatusPage" name="editGPStatusPage" method="post" action="" >
<div class="nano"> 
    <div class="comn_box recipient" style="height:500px; overflow:auto; padding:0 17px 0 0;">
    ...
    <div class="detail_row">
    <h3>Payment</h3>
    <p>Payment to www.mygyftr.com (Vouchagram India Pvt. Ltd.)  will be processed by www.payu.in  which offer the following payment options</p>
    <ul>
    	<li>- Credit Cards</li>
        <li>- Debit Cards</li>
        <li>- Net banking</li>
    ...
    <p>This company is registered in India, registered office  VOUCHAGRAM INDIA PRIVATE LIMITED, a company registered in India and having its registered office at F-35 Mansarovar Garden New Delhi - 110015 </p> 
    </div>
    ...
    <p>You are request to stop using the site immediately if you don't agree to the Terms &amp; Conditions.<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/></p>
    </div>
...
$(document).ready(function(e) {
    setTimeout(function(){ $(".nano").nanoScroller({alwaysVisible:true, contentClass:'comn_box',sliderMaxHeight: 70 });},1500);
});
</script>   